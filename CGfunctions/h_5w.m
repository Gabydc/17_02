...
dir='/home/wagm/cortes/Localdisk/Results/17_01/';
...
%[xf,iter,ee,hl1,h2,h21]=diccg_1(A,b,xi,iteration,tol,Z,l,0,'uno','1',dir,'8',100);
...
figure(s+per+200)
[ht]=plotingsolution(G,W,'solution solver', sol.pressure,1) ;
colorbar
%title('backslash')
...
title('ICCG')
figure(s+per+300)
 [h1]=plotingsolution(G,W,'def',x(:,s),1);
 colorbar
title('bs-ICCG')
figure(s+per+300)
